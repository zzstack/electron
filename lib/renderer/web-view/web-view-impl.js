...
const setupMethods = (WebViewElement) => {
  WebViewElement.prototype.getGuestInstanceId = function () {
  ...
  WebViewElement.prototype.getWebContents = function () {
    deprecate.warn('WebViewElement.prototype.getWebContents', 'remote.getGuestWebContents')
  ...
  const createBlockHandler = function (method) {
    return function (...args) {
      return ipcRendererUtils.invokeSync('ELECTRON_GUEST_VIEW_MANAGER_CALL', this.getGuestInstanceId(), method, args)
    }
  }
  ...
  const createNonBlockHandler = function (method) {
    return function (...args) {
      ipcRendererUtils.invoke('ELECTRON_GUEST_VIEW_MANAGER_CALL', this.getGuestInstanceId(), method, args)
    }
  }
  ...
  const createPromiseHandler = function (method) {
    return function (...args) {
      return ipcRendererUtils.invoke('ELECTRON_GUEST_VIEW_MANAGER_CALL', this.getGuestInstanceId(), method, args)
    }
  }
